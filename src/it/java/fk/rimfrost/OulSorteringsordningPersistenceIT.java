...
public class OulSorteringsordningPersistenceIT extends RimfrostTestSupport
{
   ...
   private static final String SPEC_EQ_STATUS = "{\"namn\":\"sorteringsordning\",\"entries\":[{\"constraints\":[{\"operator\":\"eq\",\"field\":\"status\",\"value\":\"NY\"}],\"sort_by\":{\"field\":\"skapad\",\"direction\":\"asc\"}}]}";

   /** Catch-all spec (no constraints) sorted by SKAPAD ASC. */
   private static final String SPEC_CATCH_ALL_ASC = "{\"namn\":\"catch-all\",\"entries\":[{\"sort_by\":{\"field\":\"skapad\",\"direction\":\"asc\"}}]}";
